...
SELECT * FROM despesas WHERE id = 1 AND usuario_id = 1;

SELECT * FROM despesas WHERE usuario_id = 1 ORDER BY id DESC;

SELECT * FROM investimentos WHERE id = 1 AND usuario_id = 1;

SELECT * FROM investimentos WHERE usuario_id = 1 ORDER BY id DESC;
